...
const pgdm = [
  ...
  {
    label: "PGDM in Artificial Intelligence & Business Analytics",
    icon: <Cpu className="w-4 h-4" />,
  },
  {
    label: "PGDM in International Business",
    icon: <Globe className="w-4 h-4" />,
  },
  {
    label: "PGDM in Operations and Supply Chain Management",
    icon: <Package className="w-4 h-4" />,
  },
  {
    label: "PGDM in Entrepreneurship and New Age Start-ups",
...
const mba = [
  {
    label: "MBA in Sales and Marketing",
  ...
  {
    label: "MBA in Logistics and Supply Chain Management",
    icon: <Truck className="w-4 h-4" />,
  },
  {
    label: "MBA in International Business",
    icon: <Globe className="w-4 h-4" />,
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`shrink-0 ${color === "gold" ? "text-[#fcc423]" : "text-[#60b8d4]"}`}
      >
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <div
            className="h-0.75 w-4 rounded-full opacity-40"
            style={{ background: accent }}
          />
        </div>
      </div>
...
export default function SpecializationsSection({ handleOpenForm }: Props) {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #cf1427 0%, #1a0004 0%, #cf1427 100%)",
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(252,196,35,0.08) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(96,184,212,0.08) 0%, transparent 70%)",
        }}
      />
      {/* Divider line top */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/8 border border-white/12 text-white/60 text-xs font-bold uppercase tracking-[0.18em] px-4 py-2 rounded-full">
            <BarChart2 className="w-3.5 h-3.5 text-[#fcc423]" />
        ...
        >
          {/* Banner bg */}
          <div className="absolute inset-0 bg-linear-to-r from-[#fcc423]/15 via-white/5 to-[#60b8d4]/15" />
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 px-8 py-8">
            <div>
              <p className="text-[#fcc423] text-xs font-bold uppercase tracking-widest mb-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                onClick={() => handleOpenForm()}
                className="inline-flex items-center justify-center gap-2 bg-[#cf0707] hover:bg-[#ae0505] text-[#ffffff] font-black text-sm px-7 py-3.5 rounded-xl shadow-[0_6px_24px_rgba(252,196,35,0.35)] hover:shadow-[0_10px_32px_rgba(252,196,35,0.5)] transition-all duration-200 whitespace-nowrap"
              >
                Apply Now
                <ArrowRight className="w-4 h-4" />
              </motion.a>
