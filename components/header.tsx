  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/92 backdrop-blur-xl shadow-[0_2px_32px_rgba(0,100,143,0.10)] border-b border-[#cf1427]/8"
          : "bg-white/70 backdrop-blur-md"
      }`}
    >
      {/* Top 3-px rainbow accent line */}
      <div className="absolute top-0 left-0 right-0 h-0.75 bg-linear-to-r from-[#e49099] via-[#e0d5b2] to-[#f9ced2]" />
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <motion.a
              ...
              style={{
                background: "linear-gradient(135deg, #cf1427 0%, #cf1427 100%)",
              }}
            >
              {/* Shimmer on hover */}
              <span
              ...
              <span className="relative flex h-2 w-2 shrink-0">
                ...
                <span className="relative inline-flex h-2 w-2 rounded-full bg-[#500c01] opacity-60" />
              </span>

              <span className="relative hidden xs:inline sm:inline text-white">Apply for 2026</span>
              <span className="relative xs:hidden sm:hidden text-white">Apply</span>

              <ArrowRight className="relative text-white w-4 h-4 transition-transform duration-200 group-hover:translate-x-1" />
            </motion.a>
          </motion.div>
