      ...
      <div className="max-w-6xl mx-auto text-center mb-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-5">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#cf1427] hover:bg-[#cf0317] text-white font-semibold px-6 py-3 rounded-full shadow-md transition"
          >
            <Lock size={16} />
          ...
          <button
            onClick={() => handleOpenForm()}
            className="bg-[#000000] hover:bg-[#000000] text-white font-semibold px-6 py-3 rounded-full shadow-md transition"
          >
