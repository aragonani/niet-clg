...
export default function AcademicsSection() {
  ...
  return (
    ...
    <section className="bg-[#cf1427] text-white py-12 px-6 md:px-12 flex flex-col lg:flex-row items-center justify-center gap-10 overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-2 border-t border-slate-300">
          {stats.map((stat, idx) => (
            ...
            >
              <span className="text-2xl md:text-3xl font-black text-[#cf1427]">
                {stat.isText ? (
                  stat.suffix
                ) : (
                  <>
      ...
      <div className="w-full lg:w-1/3 flex flex-col gap-8">
        <div>
          ...
          <p className="text-sm md:text-base text-blue-100 opacity-90 leading-relaxed">
            NAAC A+ accredited and ranked among the Top 50 universities in India, 
