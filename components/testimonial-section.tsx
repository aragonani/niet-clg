  ...
  return (
    <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-[#f0fafb] via-white to-[#eaf6fb]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#cf0e0e]/8 border border-[#cf0e0e]/15 text-[#cf0e0e] text-xs font-bold uppercase tracking-[0.15em] px-4 py-2 rounded-full mb-5">
            <Star className="w-3.5 h-3.5 text-[#cf0707] fill-[#cf0707]" />
            Alumni Voices
          </div>
          <h2 className="text-4xl sm:text-5xl font-black text-[#001f2d] tracking-tight leading-none">
            See What Our{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-[#cf0e0e]">Graduates</span>
              <span className="absolute -bottom-1 left-0 w-full h-2.5 bg-[#cf0e0e]/35 rounded-full z-0" />
            </span>{" "}
            Say
          </h2>
          <div className="flex items-center justify-center gap-3 mt-5">
            <div className="h-px w-12 bg-linear-to-r from-transparent to-[#cf0e0e]" />
            <div className="w-1.5 h-1.5 rounded-full bg-[#cf0e0e]" />
            <div className="h-px w-12 bg-linear-to-l from-transparent to-[#cf0e0e]" />
          </div>
        </motion.div>
        ...
        <div className="flex justify-center gap-1 mb-8">
          {[...Array(5)].map((_, i) => (
            <Star key={i} className="w-5 h-5 text-[#cf0e0e] fill-[#cf0e0e]" />
          ))}
        </div>
          ...
          {["prev","next"].map((dir2) => (
            <button
              ...
              className={`absolute top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-full
                bg-white border border-[#000000]/15 shadow-md flex items-center justify-center
                text-[#000000] hover:bg-[#000000] hover:text-white hover:border-[#000000]
            ...
            >
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-8 md:p-12 flex flex-col justify-center relative">
                  {/* Big quote icon */}
                  <Quote
                    className="absolute top-8 right-8 w-16 h-16 opacity-[0.06] text-[#00648f]"
                    style={{ transform: "rotate(180deg)" }}
                  />

                  <Quote className="w-8 h-8 text-[#fcc423] mb-5 fill-[#fcc423]/20" />
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    <div className="h-px flex-1 bg-linear-to-r from-[#fcc423]/40 to-transparent" />
                    <div className="flex gap-0.5">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-3.5 h-3.5 text-[#fcc423] fill-[#fcc423]" />
                      ))}
                    </div>
                  </div>
                </div>
          ...
          {testimonials.map((_, i) => (
            <button
              ...
              className={`rounded-full transition-all duration-300 ${
                i === active
                  ? "w-7 h-2.5 bg-[#000000]"
                  : "w-2.5 h-2.5 bg-[#000000]/25 hover:bg-[#000000]/50"
              }`}
            />
          ))}
        </div>
