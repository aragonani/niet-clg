...
const awards = [
  {
    rank: "19",
    sup: "th",
    description: "Ranked 19th in India (as indicated in 2026 application listings).",
    source: "NIRF",
    sourceStyle: "nirf",
  ...
  },
  {
    rank: "3.23",
    sup: "",
    description: "NAAC Accredited Grade ‘A’ 3.23",
    source: "NAAC",
    sourceStyle: "naac",
  ...
  },
  {
    rank: "BEST",
    sup: "",
    description: "Best B-School for Employability",
  ...
  },
  {
    rank: "43",
    sup: "rd",
    description: "Ranked 43rd Among The Top 200 Private Engineering Institutes Pan India by Outlook.",
    source: "Outlook",
    sourceStyle: "outlook",
  ...
  },
  {
    rank: "★★★★",
    sup: "",
    description: "Highest 4 Star Rating for Innovation and Entrepreneurship by IIC 2024 (GOI)",
    source: "Institution's Innovation Council",
    sourceStyle: "IIC",
  ...
  },
  {
    rank: "BEST",
    sup: "",
    description: "Awarded Diamond Subject Rating For Engineering By I-Gauge",
    source: "I-Gauge",
    sourceStyle: "I-Gauge",
    icon: <TrendingUp className="w-4 h-4" />,
    accent: "#fcc423",
...
const sourceStyles: Record<string, string> = {
  careers:  "text-[#cf1427] font-black tracking-tight text-sm border border-[#cf1427]/30 px-3 py-1 rounded",
  ghrdc:    "text-[#cf1427] font-black tracking-widest text-base",
  ...
  eminence: "text-[#cf1427] font-bold text-xs tracking-widest",
  theweek:  "text-white font-black text-sm bg-red-600 px-3 py-1 rounded",
  bw:       "text-[#cf1427] font-black text-xs tracking-wide",
  ...
  return (
    <div className="relative flex items-center justify-center w-30 h-30 mx-auto">
      ...
      <div className="relative z-10 text-center">
        <span
          className="font-black text-[#cf1427] leading-none"
          style={{
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl p-6 flex flex-col items-center text-center gap-4
        ...
        hover:shadow-[0_16px_48px_rgba(0,100,143,0.16)] hover:border-[#cf1427]/20
        transition-shadow transition-border duration-300 cursor-default"
    >
      {/* Top accent bar */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-12 h-1 rounded-b-full bg-linear-to-r from-[#fcc423] to-[#f5a800] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

      {/* Icon chip */}
      <div className="absolute top-4 right-4 w-7 h-7 rounded-full bg-[#cf1427]/8 flex items-center justify-center text-[#cf1427] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        {award.icon}
      </div>
  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-linear-to-b from-[#f0fafb] via-white to-[#f0fafb]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-0.5 bg-linear-to-r from-transparent via-[#fcc423]/40 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#cf1427]/8 text-[#cf1427] text-xs font-bold uppercase tracking-[0.15em] px-4 py-2 rounded-full mb-5 border border-[#cf1427]/15">
            <Trophy className="w-3.5 h-3.5 text-[#fcc423]" />
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-[#001f2d] tracking-tight leading-none mb-3">
            ...
            {" "}&amp;{" "}
            <span className="text-[#cf1427]">Recognitions</span>
          </h2>
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <div className="h-px w-16 bg-linear-to-r from-transparent to-[#cf1427]" />
            <div className="w-2 h-2 rounded-full bg-[#cf1427]" />
            <div className="h-px w-16 bg-linear-to-l from-transparent to-[#cf1427]" />
          </div>
        </motion.div>
        ...
        >
          {/* Background */}
          <div className="absolute inset-0 bg-linear-to-r from-[#cf1427] via-[#ec3043] to-[#b70b1de2]" />
          <div className="absolute inset-0 opacity-20"
            style={{
              backgroundImage: "radial-gradient(circle at 20% 50%, #fcc423 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(255,255,255,0.2) 0%, transparent 50%)",
            }}
          />
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 px-8 sm:px-12 py-10">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center gap-2 justify-center md:justify-start mb-3">
                <Award className="w-5 h-5 text-[#fcc423]" />
                <span className="text-[#fcc423] text-sm font-bold uppercase tracking-widest">
            ...
            <div className="flex flex-col sm:flex-row md:flex-col gap-3 shrink-0">
              <motion.a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#000000] hover:bg-[#000000] text-[#ffffff] font-black text-sm px-8 py-4 rounded-xl shadow-[0_8px_28px_rgba(252,196,35,0.4)] hover:shadow-[0_12px_36px_rgba(252,196,35,0.55)] transition-all duration-200 whitespace-nowrap"
              >
